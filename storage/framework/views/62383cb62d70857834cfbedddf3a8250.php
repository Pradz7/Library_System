                ...
                <div class="book-card">
                    <div class="row g-0 h-100">
                        <div class="col-md-4 book-image-container">
                            <img src="<?php echo e(asset('book/' . $data->book_img)); ?>" 
                                 class="book-image" 
                        ...
                        <div class="col-md-8 h-100">
                            <div class="book-details">
                                <div>
                                    <h2 class="book-title"><?php echo e($data->title); ?></h2>
                                    <div class="book-author"><?php echo e($data->author); ?></div>
                                    <div class="book-isbn">ISBN: <?php echo e($data->ISBN); ?></div>
                                </div>
                                
                                <div class="availability-section">
                                    <div class="availability-text">
                                        Copies Available:
                                        <span class="availability-number"><?php echo e($data->quantity); ?></span>
                                    </div>
...
<?php /**PATH /Users/madeprabawa/Desktop/Library_Project/resources/views/home/explore.blade.php ENDPATH**/ ?>